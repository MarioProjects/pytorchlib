...
def database_selector(db, gray=0, seed=0, fold_test=0, batch_size=128, norm="None", show_info=True, desired_img_size=(224, 224), data_segment="0_10000", evalution_mode=False):
    ...
    if db=="LFW":
        ...
        train_samples, train_loader = quick_draw_doodle(seed=seed, train_segment=data_segment, batch_size=batch_size, norm=norm, desired_img_size=desired_img_size, evalution_mode=evalution_mode)
