...
class NASNetALarge(nn.Module):
    ...
    def __init__(self, input_channels, num_classes=1001, stem_filters=96, penultimate_filters=4032, filters_multiplier=2):
        ...
        self.conv0.add_module('conv', nn.Conv2d(in_channels=input_channels, out_channels=self.stem_filters, kernel_size=3, padding=0, stride=2,
                                                bias=False))
...
def NasNetALargeModel(input_channels, num_classes=1001, pretrained='imagenet'):
    ...
    if pretrained:
        ...
        model = NASNetALarge(3, num_classes=1001)
        ...
        model = NASNetALarge(input_channels, num_classes=num_classes)
    return model
